...
<template>
        ...
        <nav class="sidebar-nav">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              ...
              <ul
                aria-expanded="false"
                class="collapse first-level base-level-line text-gray"
              >
                <li class="sidebar-item">
                  <a href="table-basic.html" class="sidebar-link"
                    ><span class="hide-menu text-black"> Basic Table </span></a
                  >
                </li>
                <li class="sidebar-item">
  ...
  <div class="text-center" v-show="!logged">
    <div class="w-full min-vh-100 d-flex align-items-center justify-content-center">
